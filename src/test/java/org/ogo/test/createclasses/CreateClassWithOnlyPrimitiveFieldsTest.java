...
public class CreateClassWithOnlyPrimitiveFieldsTest {
  ...
  public void testCreateClassLongFields() throws Exception {
    OGO.inMemory = true;
    Object[] results =
        query("CREATE (a:`DummyClass` {property1 : 1, property2 : 2, property3 : 3}) RETURN a");
    assertEquals(
        3,
        results[0].getClass().getDeclaredFields().length,
        "Mismatch in expected number of fields");
    ...
    assertEquals(
        "long",
        field1.getAnnotatedType().getType().getTypeName(),
        "Mismatch in expected type of field 'property1'");
    assertEquals(
        "long",
        field2.getAnnotatedType().getType().getTypeName(),
        "Mismatch in expected type of field 'property2'");
    assertEquals(
        "long",
        field3.getAnnotatedType().getType().getTypeName(),
  ...
  public void testCreateClassBooleanFields() throws Exception {
    ...
    Object[] results =
        query(
            "CREATE (a:`DummyClass` {property1 : TRUE, property2 : TRUE, property3 : FALSE}) RETURN"
                + " a");
    assertEquals(
        3,
        results[0].getClass().getDeclaredFields().length,
  ...
  public void testCreateClassStringFields() throws Exception {
    ...
    Object[] results =
        query(
            "CREATE (a:`DummyClass` {property1 : 'Apple', property2 : 'Banana', property3 :"
                + " 'Orange'}) RETURN a");
    assertEquals(
        3,
        results[0].getClass().getDeclaredFields().length,
    ...
    assertEquals(
        "'Apple'", field1.get(results[0]), "Mismatch in expected value of field 'property1'");
    assertEquals(
        "'Banana'", field2.get(results[0]), "Mismatch in expected value of field 'property2'");
    assertEquals(
        "'Orange'", field3.get(results[0]), "Mismatch in expected value of field 'property3'");
  }
  ...
  public void testCreateClassMixedPrimitiveFields1() throws Exception {
    ...
    Object[] results =
        query(
            "CREATE (a:`DummyClass` {property1 : 100, property2 : 'Banana', property3 :"
                + " TRUE}) RETURN a");
    assertEquals(
        3,
        results[0].getClass().getDeclaredFields().length,
  ...
  public void testCreateClassMixedPrimitiveFields2() throws Exception {
    ...
    Object[] results =
        query(
            "CREATE (a:`DummyClass` {property1 : 'Hello', property2 : 'Banana', property3 :"
                + " 345.6}) RETURN a");
    assertEquals(
        3,
        results[0].getClass().getDeclaredFields().length,
    ...
    assertEquals(
        "'Hello'", field1.get(results[0]), "Mismatch in expected value of field 'property1'");
    assertEquals(
        "'Banana'", field2.get(results[0]), "Mismatch in expected value of field 'property2'");
