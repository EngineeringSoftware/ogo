...
public abstract class ClassHelper {
     ...
     *            Name of the class
     * @param packageName
     *            Name of the package containing the class (must be null if no package)
     * @param fieldNames
     *            String array containing field names
     * @param fieldTypes
     *            String array containing field types
     *
     * @return The dynamically created class's class instance
     */
    public static Class<?> createClass(String className, String packageName, String[] fieldNames, String[] fieldTypes,
            Object[] fieldValues) {
