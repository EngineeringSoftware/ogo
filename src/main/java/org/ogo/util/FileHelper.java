...
public abstract class FileHelper {
    ...
    /**
     * @brief Searches the directory specified by 'dirName' for files with extension specified by 'endsWith'. Use this
     *        to search for *.csv files exported from native agent
     *
     * @param dirName
     ...
     *            Cypher query String
     * @param objects
     *            The objects passed as arg to replace with their hashcodes
     *
