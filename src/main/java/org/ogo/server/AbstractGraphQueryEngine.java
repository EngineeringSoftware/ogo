...
public abstract class AbstractGraphQueryEngine {
     ...
     *
     * @param dirName
     *            Directory where the file is present
     * @param fileName
     *            name of the file
     * @param propertyName
     *            Names of all the properties present in the file (returned by the function)
     * @param propertyValue
     *            Values of all the properties present in the file (returned by the function)
     * @param propertyType
        ...
        if (file.isFile() && file.exists()) {
            ...
            try {
                ...
                while (scan.hasNext()) {
                    ...
                    /*
                     * If the property value is not string then it could potentially be a primitive array which is
                     * stored as comma-separated element values in the [*TAG*]_Neo4JProperties.csv file We need to
                     * extract each element and cast it into Object type hence the StringTokenizer
                     */
                    if (!tokens[PROPERTY_FILE_INDEX.PROPERTY_TYPE.ordinal()].equalsIgnoreCase("JSTRING")) {
                        StringTokenizer tokens2 = new StringTokenizer(
                                tokens[PROPERTY_FILE_INDEX.PROPERTY_VALUE.ordinal()], ",");
     ...
     *        <p>
     *        Example : tokens : str , [UTAUSTIN] , string lexemes : PROPERTY_NAME | PROPERTY_VALUE | PROPERTY_TYPE
     *
     * @param line
     *            String corresponding to a line in [*TAG*]_Neo4JProperties.csv file
     *
