...
public final class GraphTriggerException extends Exception {
     ...
     * @param root
     */
    public GraphTriggerException(boolean inMemory, boolean forceGC, boolean followRoot, boolean whitelist,
            String cQuery, Object root, Object[] whiteLists, Object[] blackLists, Object[] excludeBlackListing) {
     ...
     */
    public GraphTriggerException(boolean inMemory, boolean forceGC, boolean followRoot, boolean whitelist,
            String cQuery, Object[] whiteLists, Object[] blackLists, Object[] excludeBlackListing) {
        this.inMemory = inMemory;
        this.forceGC = forceGC;
        this.followRoot = followRoot;
        this.whitelist = whitelist;
    ...
    public Object[] getQueryResults() throws UnsupportedOperationException {
        if (!inMemory)
            throw new UnsupportedOperationException("Error : Can only be called when 'inMemory' flag is set");
        return queryResult;
    }
}
