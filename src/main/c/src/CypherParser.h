...
public:
  ...
  enum {
    ...
    RuleOC_NodePattern = 38,
    RuleOC_PatternElementChain = 39,
    RuleOC_RelationshipPattern = 40,
    RuleOC_RelationshipDetail = 41,
    RuleOC_Properties = 42,
    RuleOC_RelationshipTypes = 43,
    RuleOC_NodeLabels = 44,
    RuleOC_NodeLabel = 45,
    RuleOC_RangeLiteral = 46,
    RuleOC_LabelName = 47,
    RuleOC_RelTypeName = 48,
    RuleOC_Expression = 49,
    RuleOC_OrExpression = 50,
    RuleOC_XorExpression = 51,
    RuleOC_AndExpression = 52,
    RuleOC_NotExpression = 53,
    RuleOC_ComparisonExpression = 54,
    RuleOC_AddOrSubtractExpression = 55,
    RuleOC_MultiplyDivideModuloExpression = 56,
    RuleOC_PowerOfExpression = 57,
    RuleOC_UnaryAddOrSubtractExpression = 58,
    RuleOC_StringListNullOperatorExpression = 59,
    RuleOC_ListOperatorExpression = 60,
    RuleOC_StringOperatorExpression = 61,
    RuleOC_NullOperatorExpression = 62,
    RuleOC_PropertyOrLabelsExpression = 63,
    RuleOC_Atom = 64,
    RuleOC_Literal = 65,
    RuleOC_BooleanLiteral = 66,
    RuleOC_ListLiteral = 67,
    RuleOC_PartialComparisonExpression = 68,
    RuleOC_ParenthesizedExpression = 69,
    RuleOC_RelationshipsPattern = 70,
    RuleOC_FilterExpression = 71,
    RuleOC_IdInColl = 72,
    RuleOC_FunctionInvocation = 73,
    RuleOC_FunctionName = 74,
    RuleOC_ExistentialSubquery = 75,
    RuleOC_ExplicitProcedureInvocation = 76,
    RuleOC_ImplicitProcedureInvocation = 77,
    RuleOC_ProcedureResultField = 78,
    RuleOC_ProcedureName = 79,
    RuleOC_Namespace = 80,
    RuleOC_ListComprehension = 81,
    RuleOC_PatternComprehension = 82,
    RuleOC_PropertyLookup = 83,
    RuleOC_CaseExpression = 84,
    RuleOC_CaseAlternative = 85,
    RuleOC_Variable = 86,
    RuleOC_NumberLiteral = 87,
    RuleOC_MapLiteral = 88,
    RuleOC_Parameter = 89,
    RuleOC_PropertyExpression = 90,
    RuleOC_PropertyKeyName = 91,
    RuleOC_IntegerLiteral = 92,
    RuleOC_DoubleLiteral = 93,
    RuleOC_SchemaName = 94,
    RuleOC_ReservedWord = 95,
    RuleOC_SymbolicName = 96,
    RuleOC_LeftArrowHead = 97,
    RuleOC_RightArrowHead = 98,
    RuleOC_Dash = 99
  };
  ...
  public:
    ...
    oC_PartialComparisonExpression(size_t i);
    std::vector<antlr4::tree::TerminalNode *> SP();
    antlr4::tree::TerminalNode *SP(size_t i);
  ...
  public:
    ...
    oC_UnaryAddOrSubtractExpression(size_t i);
    std::vector<antlr4::tree::TerminalNode *> SP();
    antlr4::tree::TerminalNode *SP(size_t i);
  ...
  public:
    ...
    std::vector<OC_StringOperatorExpressionContext *>
