...
MatchClauseVisitor::MatchClauseVisitor(Agent* agent,
...
any MatchClauseVisitor::visitOC_SinglePartQuery(CypherParser::OC_SinglePartQueryContext *ctx) {
...
any MatchClauseVisitor::visitOC_MultiPartQuery(CypherParser::OC_MultiPartQueryContext *ctx) {
    for(int j = 0; j < ctx->oC_ReadingClause().size(); j++) {
        ctx->oC_ReadingClause()[j]->accept(this);
    }
    return any();
...
any MatchClauseVisitor::visitOC_ReadingClause(CypherParser::OC_ReadingClauseContext *ctx) {
    if(ctx->oC_Match()) {
...
any MatchClauseVisitor::visitOC_PatternElement(CypherParser::OC_PatternElementContext *ctx) {
...
any MatchClauseVisitor::visitOC_NodePattern(CypherParser::OC_NodePatternContext *ctx) {
    ...
    if(ctx->oC_Properties()) {
        AST_NODE_RETURN(ctx->oC_Properties()->accept(this), properties, map<string, pair<string, Agent::jvmtiExtendedFieldType>>)
    }
...
any MatchClauseVisitor::visitOC_Variable(CypherParser::OC_VariableContext *ctx) {
...
any MatchClauseVisitor::visitOC_SymbolicName(CypherParser::OC_SymbolicNameContext *ctx) {
...
any MatchClauseVisitor::visitOC_Properties(CypherParser::OC_PropertiesContext *ctx) {
...
any MatchClauseVisitor::visitOC_MapLiteral(CypherParser::OC_MapLiteralContext *ctx) {
    if(ctx->oC_PropertyKeyName().size() > 0 &&
        ...
        for(int  j = 0; j < ctx->oC_PropertyKeyName().size(); j++) {
            ...
            if(lhsReturn.has_value() &&
                    rhsReturn.has_value()) {
                properties.insert({any_cast<string>(lhsReturn), any_cast<pair<string, Agent::jvmtiExtendedFieldType>>(rhsReturn)});
            }
        }
        return properties;
    }
...
any MatchClauseVisitor::visitOC_PropertyKeyName(CypherParser::OC_PropertyKeyNameContext *ctx) {
...
any MatchClauseVisitor::visitOC_Expression(CypherParser::OC_ExpressionContext *ctx) {
...
any MatchClauseVisitor::visitOC_OrExpression(CypherParser::OC_OrExpressionContext *ctx) {
...
any MatchClauseVisitor::visitOC_XorExpression(CypherParser::OC_XorExpressionContext *ctx) {
    /* Property based node pattern filtering can only have one property
     * value per property key */
...
any MatchClauseVisitor::visitOC_AndExpression(CypherParser::OC_AndExpressionContext *ctx) {
    /* Property based node pattern filtering can only have one property
    * value per property key */
...
any MatchClauseVisitor::visitOC_NotExpression(CypherParser::OC_NotExpressionContext *ctx) {
    /* Property based node pattern filtering can only have one property
    * value per property key */
...
any MatchClauseVisitor::visitOC_ComparisonExpression(CypherParser::OC_ComparisonExpressionContext *ctx) {
    /* Property based node pattern filtering can only have one property
     * value per property key */
...
any MatchClauseVisitor::visitOC_AddOrSubtractExpression(CypherParser::OC_AddOrSubtractExpressionContext *ctx) {
    /* Property based node pattern filtering can only have one property
     * value per property key */
...
any MatchClauseVisitor::visitOC_MultiplyDivideModuloExpression(CypherParser::OC_MultiplyDivideModuloExpressionContext *ctx) {
    /* Property based node pattern filtering can only have one property
     * value per property key */
...
any MatchClauseVisitor::visitOC_PowerOfExpression(CypherParser::OC_PowerOfExpressionContext *ctx) {
    /* Property based node pattern filtering can only have one property
     * value per property key */
...
any MatchClauseVisitor::visitOC_UnaryAddOrSubtractExpression(CypherParser::OC_UnaryAddOrSubtractExpressionContext *ctx) {
    /* Property based node pattern filtering can only have one property
     * value per property key */
...
any MatchClauseVisitor::visitOC_StringListNullOperatorExpression(CypherParser::OC_StringListNullOperatorExpressionContext *ctx) {
    /* Property based node pattern filtering can only have one property
     * value per property key */
...
any MatchClauseVisitor::visitOC_PropertyOrLabelsExpression(CypherParser::OC_PropertyOrLabelsExpressionContext *ctx) {
    if(ctx->oC_Atom()) {
...
any MatchClauseVisitor::visitOC_Literal(CypherParser::OC_LiteralContext *ctx) {
    if(ctx->oC_NumberLiteral()) {
        ...
        return pair<string, Agent::jvmtiExtendedFieldType> {stringLiteral, Agent::JVMTI_EXTENDED_FIELD_TYPE_STRING};
...
any MatchClauseVisitor::visitOC_NumberLiteral(CypherParser::OC_NumberLiteralContext *ctx) {
...
any MatchClauseVisitor::visitOC_DoubleLiteral(CypherParser::OC_DoubleLiteralContext *ctx) {
    ...
    if(ctx->ExponentDecimalReal()) {
        ...
        return pair<string, Agent::jvmtiExtendedFieldType> {ctx->RegularDecimalReal()->getSymbol()->getText(), Agent::JVMTI_EXTENDED_FIELD_TYPE_FLOAT};
    }
    return any();
}

any MatchClauseVisitor::visitOC_IntegerLiteral(CypherParser::OC_IntegerLiteralContext *ctx) {
    if(ctx->DecimalInteger()) {
        return pair<string, Agent::jvmtiExtendedFieldType> {ctx->DecimalInteger()->getSymbol()->getText(), Agent::JVMTI_EXTENDED_FIELD_TYPE_INT};
    }
...
any MatchClauseVisitor::visitOC_BooleanLiteral(CypherParser::OC_BooleanLiteralContext *ctx) {
    if(ctx->TRUE()) {
        return pair<string, Agent::jvmtiExtendedFieldType> {ctx->TRUE()->getSymbol()->getText(), Agent::JVMTI_EXTENDED_FIELD_TYPE_BOOLEAN};
    } else if(ctx->FALSE()) {
        return pair<string, Agent::jvmtiExtendedFieldType> {ctx->FALSE()->getSymbol()->getText(), Agent::JVMTI_EXTENDED_FIELD_TYPE_BOOLEAN};
    }
    return any();
}
