...
static void getCastedBinaryOperands(
    const jvalue &leftValue, const enum Agent::MethodReturnType &leftType,
    const jvalue &rightValue, const enum Agent::MethodReturnType &rightType,
    jvalue &leftCastedValue, jvalue &rightCastedValue,
    enum Agent::MethodReturnType castedType);
namespace arithmetic {
LiteralExpr *ADD(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *SUB(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *MUL(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *DIV(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *MDIV(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *EXP(LiteralExpr *left, LiteralExpr *right);
} // namespace arithmetic
namespace comparison {
LiteralExpr *EQ(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *NEQ(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *LT(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *GT(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *LEQ(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *GEQ(LiteralExpr *left, LiteralExpr *right);
} // namespace comparison
namespace boolean {
LiteralExpr *AND(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *OR(LiteralExpr *left, LiteralExpr *right);
LiteralExpr *XOR(LiteralExpr *left, LiteralExpr *right);
} // namespace boolean
