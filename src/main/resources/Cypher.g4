...
oC_PartialComparisonExpression
                           :  ( EQ SP? oC_AddOrSubtractExpression )
                               | ( NEQ SP? oC_AddOrSubtractExpression )
                               | ( LT SP? oC_AddOrSubtractExpression )
                               | ( GT SP? oC_AddOrSubtractExpression )
                               | ( LTEQ SP? oC_AddOrSubtractExpression )
                               | ( GTEQ SP? oC_AddOrSubtractExpression )
                               ;
